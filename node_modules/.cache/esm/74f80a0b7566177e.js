let forEachAttr,getValueForKeyName;_756‍.x([["createDataObjectFromElement",()=>createDataObjectFromElement],["addDataFromElementToDataObject",()=>addDataFromElementToDataObject]]);_756‍.w("../hummingbird/lib/dom",[["forEachAttr",["forEachAttr"],function(v){forEachAttr=v}]]);_756‍.w("../data-utilities",[["getValueForKeyName",["getValueForKeyName"],function(v){getValueForKeyName=v}]]);
...
function getSaveDataFromElement(elem) {
  ...
  _756‍.a("forEachAttr",forEachAttr)(elem, attrName => {
    if (attrName.indexOf(keyPrefix) === 0) {
      ...
      data[camelCaseKeyName] = _756‍.a("getValueForKeyName",getValueForKeyName)({ elem, keyName });
    }
  });
