let createUserData,getUserData,setUserData,showConsoleError,capture,getReservedWordInfo,sendEmail;_a7e‍.x([["initUserAccounts",()=>initUserAccounts]]);_a7e‍.w("./user-data",[["createUserData",["createUserData"],function(v){createUserData=v}],["getUserData",["getUserData"],function(v){getUserData=v}],["setUserData",["setUserData"],function(v){setUserData=v}]]);_a7e‍.w("../utils/console-utils",[["showConsoleError",["showConsoleError"],function(v){showConsoleError=v}]]);_a7e‍.w("../utils/async-utils",[["capture",["capture"],function(v){capture=v}]]);_a7e‍.w("../utils/get-reserved-word-info",[["getReservedWordInfo",["getReservedWordInfo"],function(v){getReservedWordInfo=v}]]);_a7e‍.w("../utils/send-email",[["sendEmail",["sendEmail"],function(v){sendEmail=v}]]);const passport = require("passport");
