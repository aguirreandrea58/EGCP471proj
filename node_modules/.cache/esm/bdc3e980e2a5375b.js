let lodash,deepdash,capture,getUniqueId,setUserData;_e2a‍.x([["processData",()=>processData]]);_e2a‍.w("lodash",[["default",["lodash"],function(v){lodash=v}]]);_e2a‍.w("deepdash",[["default",["deepdash"],function(v){deepdash=v}]]);_e2a‍.w("./async-utils",[["capture",["capture"],function(v){capture=v}]]);_e2a‍.w("../lib/get-unique-id",[["getUniqueId",["getUniqueId"],function(v){getUniqueId=v}]]);_e2a‍.w("../lib/user-data",[["setUserData",["setUserData"],function(v){setUserData=v}]]);
