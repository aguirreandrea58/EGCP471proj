let lodash,deepdash,getUniqueId,getUserData,getParams,getPartial,capture,processData,showConsoleError,getBootstrapData,getQueryParams,getHtmlWithUniqueIds,getSaveData,RemakeStore;_f62‍.x([["initApiNew",()=>initApiNew]]);_f62‍.w("lodash",[["default",["lodash"],function(v){lodash=v}]]);_f62‍.w("deepdash",[["default",["deepdash"],function(v){deepdash=v}]]);_f62‍.w("./get-unique-id",[["getUniqueId",["getUniqueId"],function(v){getUniqueId=v}]]);_f62‍.w("./user-data",[["getUserData",["getUserData"],function(v){getUserData=v}]]);_f62‍.w("../utils/get-params",[["getParams",["getParams"],function(v){getParams=v}]]);_f62‍.w("../utils/get-partials",[["getPartial",["getPartial"],function(v){getPartial=v}]]);_f62‍.w("../utils/async-utils",[["capture",["capture"],function(v){capture=v}]]);_f62‍.w("../utils/process-data",[["processData",["processData"],function(v){processData=v}]]);_f62‍.w("../utils/console-utils",[["showConsoleError",["showConsoleError"],function(v){showConsoleError=v}]]);_f62‍.w("../utils/get-bootstrap-data",[["getBootstrapData",["getBootstrapData"],function(v){getBootstrapData=v}]]);_f62‍.w("../utils/get-query-params",[["getQueryParams",["getQueryParams"],function(v){getQueryParams=v}]]);_f62‍.w("../utils/get-html-with-unique-ids",[["getHtmlWithUniqueIds",["getHtmlWithUniqueIds"],function(v){getHtmlWithUniqueIds=v}]]);_f62‍.w("../client-side/get-save-data",[["getSaveData",["getSaveData"],function(v){getSaveData=v}]]);_f62‍.w("./remake-store",[["default",["RemakeStore"],function(v){RemakeStore=v}]]);
