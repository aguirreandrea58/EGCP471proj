let isValidCommand,showError,callSaveFunction,triggerWatchAttributes,executeCommandOnMultipleElements,getTargetsForCommand,forEachAttr;_756‍.x([["getTargetElemsForKeyName",()=>getTargetElemsForKeyName],["setValueForKeyName",()=>setValueForKeyName],["getValueForKeyName",()=>getValueForKeyName],["getClosestElemWithKey",()=>getClosestElemWithKey],["getValueForClosestKey",()=>getValueForClosestKey],["setValueForClosestKey",()=>setValueForClosestKey],["getKeyNamesFromElem",()=>getKeyNamesFromElem]]);_756‍.w("../common/get-valid-element-properties",[["isValidCommand",["isValidCommand"],function(v){isValidCommand=v}]]);_756‍.w("../common/show-error",[["showError",["showError"],function(v){showError=v}]]);_756‍.w("../inputjs/onSave",[["callSaveFunction",["callSaveFunction"],function(v){callSaveFunction=v}]]);_756‍.w("./commandAndWatchHelpers",[["triggerWatchAttributes",["triggerWatchAttributes"],function(v){triggerWatchAttributes=v}],["executeCommandOnMultipleElements",["executeCommandOnMultipleElements"],function(v){executeCommandOnMultipleElements=v}],["getTargetsForCommand",["getTargetsForCommand"],function(v){getTargetsForCommand=v}]]);_756‍.w("../hummingbird/lib/dom",[["forEachAttr",["forEachAttr"],function(v){forEachAttr=v}]]);
...
function _valueForKeyName({ method, elem, keyName, value = "" }) {
  ...
  if (!normalKeyExists && !temporaryKeyExists) {
    _756‍.a("showError",showError)("You can't set a key name to a value if the key doesn't exist on the element yet");
    return;
  }

  let attrName = normalKeyExists ? "key:" + dashCaseKeyName : "temporary:key:" + dashCaseKeyName;
  let attrValue = elem.getAttribute(attrName);
  let hasValidCommand = _756‍.a("isValidCommand",isValidCommand)({ commandName: attrValue, includingSearchCommand: true });
  ...
  if (!hasValidCommand) {
    ...
    let targets = _756‍.a("getTargetsForCommand",getTargetsForCommand)({ elem, dashCaseKeyName, attrName, attrValue });
    targetElems = targets.targetElems;
    targetAttr = targets.targetAttr;
    if (method === "set") {
      _756‍.a("executeCommandOnMultipleElements",executeCommandOnMultipleElements)({ targetElems, targetAttr, value, method });
    } else {
      return _756‍.a("executeCommandOnMultipleElements",executeCommandOnMultipleElements)({ targetElems, targetAttr, value, method });
    }
  }
  ...
  if (method === "set") {
    ...
    if (!settingTemporaryKey) {
      _756‍.a("callSaveFunction",callSaveFunction)(elem);
    }
    ...
    _756‍.a("triggerWatchAttributes",triggerWatchAttributes)({ elem, dashCaseKeyName, value, targetElems });
  }
}
...
// returns keynames with dashes in them: ["example-key", "another-example"]
  ...
  _756‍.a("forEachAttr",forEachAttr)(elem, attrName => {
