let setValueForKeyName,forEachAttr;_fb5‍.x([["setAllDataToEmptyStringsExceptIds",()=>setAllDataToEmptyStringsExceptIds]]);_fb5‍.w("./getAndSetKeyValues",[["setValueForKeyName",["setValueForKeyName"],function(v){setValueForKeyName=v}]]);_fb5‍.w("../hummingbird/lib/dom",[["forEachAttr",["forEachAttr"],function(v){forEachAttr=v}]]);
...
// needs to work on temporary keys because that's what the popover uses to store data
  ...
  _fb5‍.a("forEachAttr",forEachAttr)(elem, function (attrName, attrValue) {
    let keyPrefix = "key:";
    if (attrName.startsWith(keyPrefix) && attrName !== "key:id") {
      let keyName = attrName.substring(keyPrefix.length);
      _fb5‍.a("setValueForKeyName",setValueForKeyName)({ elem, keyName, value: "" });
    }
